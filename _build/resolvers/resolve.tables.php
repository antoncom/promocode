...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('promocode_core_path', null, $modx->getOption('core_path') . 'components/promocode/') . 'model/';
            $modx->addPackage('promocode', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/promocode/model/schema/promocode.mysql.schema.xml';
